...
2. Clone this repo or download and unzip [this](https://github.com/brleinad/eire-schools/archive/main.zip)
3. Open a command line and head to the directory eire-schools that you just unzipped or cloned.
